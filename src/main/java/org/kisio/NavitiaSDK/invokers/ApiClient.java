...
import org.kisio.NavitiaSDK.invokers.auth.Authentication;
import org.kisio.NavitiaSDK.invokers.auth.HttpBasicAuth;
import org.kisio.NavitiaSDK.invokers.auth.ApiKeyAuth;
import org.kisio.NavitiaSDK.invokers.auth.OAuth;
...
public class ApiClient {
    ...
    public String escapePathParam(String str) {
        String[] parts = str.split("/");
        String result = "";
        for (int i = 0; i <= parts.length - 1; i++) {
            parts[i] = this.escapeString(parts[i]);
        }
